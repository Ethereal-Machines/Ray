...
class H264VideoEncBin(VideoEncBinBase):
    ...
    def _constructEncChain(self):
        self.__encoderElement = Gst.ElementFactory.make(
            'omxh264enc', 'h264_encoder')

        # CAPABILITIES FOR H264 OUTPUT
        self.__encoderCaps = Gst.ElementFactory.make(
            "capsfilter", "encoder_filter")
        self.__encoderCaps.set_property(
