...
from astroprint.printfiles import MetadataAnalyzerResults
...
class PrintFileManagerX3g(PrintFilesManager):
    ...
    def __init__(self):
        ...
        self._metadataAnalyzer = X3gMetadataAnalyzer(
...
class X3gMetadataAnalyzer(MetadataAnalyzer):
    def __init__(self, getPathCallback, loadedCallback):
        self._logger = logging.getLogger(__name__)
        super(X3gMetadataAnalyzer, self).__init__(
    ...
    def _analyzeFile(self, filename):
        ...
        try:
            ...
            self._loadedCallback(
                self._currentFile, MetadataAnalyzerResults())
        finally:
